...
int main( )
{
    ...
    cout << "2) Run an individual test" << endl;
    cin >> choice;
    ...
    if(choice == 1){
        ...
        cout << "Enter a test to run (1,2,3, or 4)" << endl;
        cin >> choice;
        switch (choice) {
            case 1:
                sum += run_a_test(1, DESCRIPTION[1], test1, POINTS[1]);
                cout << "If you submit this PriorityQueue now, you will have\n";
                cout << sum << " points out of the " << POINTS[1];
                cout << " points from this test case.\n";
                break;
            case 2:
                sum += run_a_test(2, DESCRIPTION[2], test2, POINTS[2]);
                cout << "If you submit this PriorityQueue now, you will have\n";
                cout << sum << " points out of the " << POINTS[2];
                cout << " points from this test case.\n";
                break;
            case 3:
                sum += run_a_test(3, DESCRIPTION[3], test3, POINTS[3]);
                cout << "If you submit this PriorityQueue now, you will have\n";
                cout << sum << " points out of the " << POINTS[3];
                cout << " points from this test case.\n";
                break;
            case 4:
                sum += run_a_test(4, DESCRIPTION[4], test4, POINTS[4]);
                cout << "If you submit this PriorityQueue now, you will have\n";
                cout << sum << " points out of the " << POINTS[4];
                cout << " points from this test case.\n";
                break;
            default:
